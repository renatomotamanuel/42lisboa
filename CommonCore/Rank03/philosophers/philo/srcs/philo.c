...
/*   Updated: 2025/04/23 14:17:50 by rmota-ma         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_philo(void)
{
	...
	if (prog()->args[0] == 1)
		pthread_create(&prog()->philo[0].thread, NULL, lone_philo,  (void*)&prog()->philo[0].id);
	else
		multiple_philos();
}
...
void	think_eat_sleep(int id)
{
	...
	if(prog()->philo[id].dead == 1 || (prog()->meal == prog()->args[0] && prog()->argc == 6))
	{
